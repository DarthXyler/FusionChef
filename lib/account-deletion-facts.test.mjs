...
async function createFixture() {
  ...
  await client.executeMultiple(`
    INSERT INTO auth_users VALUES (
      ...
      'Sensitive User', '${PUBLIC_BASE_URL}/profile-photos/private-avatar.webp',
    ...
    INSERT INTO cookbook_recipes VALUES (
      ...
      '{"ingredients":["secret"]}',
      '${PUBLIC_BASE_URL}/recipe-images/private-recipe.webp',
...
const sameCountMutations = [
  ...
  ["cookbook image reference", "UPDATE cookbook_recipes SET image_url = 'https://cdn.example.test/recipe-images/changed.webp' WHERE row_id = 'recipe-row'"],
  ...
  ["R2 profile reference", "UPDATE auth_users SET avatar_url = 'https://cdn.example.test/profile-photos/changed.webp' WHERE id = 'auth-fact-user'"],
];
